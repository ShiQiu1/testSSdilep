...
ntuple_signal_tau_fast           = Sample( name =  "ntuple_signal_tau_fast",       xsec = 1.     )


fast_sim = Sample( name =  'fast_sim',
                   tlatex = 'm_{H^{\pm\pm}}=all',
                   line_color = ROOT.kOrange-3,
                   marker_color = ROOT.kOrange-3,
                   fill_color = ROOT.kOrange-3,
                   ...
                   line_style = 1,
                   fill_style = 3004,
                   daughters = [ntuple_signal_tau_fast]
                )

ntuple_signal_tau_full            = Sample( name =  "ntuple_signal_tau_full",        xsec = 1. )

full_sim = Sample( name =  'full_sim',
                   tlatex = 'm_{H^{\pm\pm}}=all',
                   ...
                   line_style = 1,
                   fill_style = 3004,
                   daughters = [ntuple_signal_tau_full]
                )
