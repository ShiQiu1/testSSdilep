...
def analyze(config):
    ...
    loop += ssdilep.algs.algs.CutAlg(cutflow='presel',cut='OneTauOneMu')
    ...
    ## ---------------------------------------
    loop += ssdilep.algs.vars.TauMuVars() 
    ...
    hist_list = []
    hist_list += ssdilep.hists.TauMu_hists.hist_list
    ...
    loop += ssdilep.algs.algs.PlotAlg(
             ...
             cut_flow = [
                ['OSTauMu',None],
                ['TauMudPhiLessThan95Pi',None],                
                ['TauMudPhiLessThan90Pi',None],
                ],
             )              
